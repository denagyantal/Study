...
def evaluate_models_on_training(x, y, models):
    ...
    for model in models:
        ...
        yVals = np.array(y)
        # measured data
        pylab.plot(xVals,yVals, label='Measured Temperature')
...
#        yTest = a*xVals + b
        ...
        # MSE
        MSE = r_squared(yVals, estyVals)
#        MSE_test = r_squared(yVals, yTest) 
        
        pylab.plot(xVals,estyVals, label= str(len(model)-1) +'. degree fitting ; MSE = ' + str(MSE))
#        pylab.plot(xVals,yTest, label= str(len(model)-1) +'. degree fitting ; MSE = ' + str(MSE_test))
